...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="LblFirstName" runat="server" style="z-index: 1; left: 463px; top: 365px; position: absolute" Text="Please enter a First Name"></asp:Label>
        ...
        <asp:Button ID="BtnAdd" runat="server" style="z-index: 1; left: 464px; top: 467px; position: absolute; width: 55px; height: 23px" Text="Add" />
        ...
        <asp:Button ID="BtnDelete" runat="server" style="z-index: 1; left: 577px; top: 466px; position: absolute" Text="Delete" />
    </form>
</body>
</html>
